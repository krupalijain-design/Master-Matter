          ...
          <ResponsiveContainer width="100%" height="100%">
            {def.viz === "Bar" ? (
              <BarChart data={chartData} margin={{ top: 8, right: 8, left: 0, bottom: 8 }}>
                ...
                <Bar dataKey={primaryAgg} fill="hsl(var(--accent))" radius={[4, 4, 0, 0]} onClick={(d) => onDrillRow?.(d as Record<string, unknown>)}>
              ...
              <LineChart data={chartData} margin={{ top: 8, right: 8, left: 0, bottom: 8 }}>
                ...
                <YAxis tick={{ fontSize: 11 }} />
                <Tooltip content={<ChartTip />} />
                <Line type="monotone" dataKey={primaryAgg} stroke="hsl(var(--accent))" strokeWidth={2} dot={{ r: 3 }} />
              </LineChart>
            ) : (
              <FunnelChart>
                <Tooltip content={<ChartTip />} />
                <Funnel dataKey={primaryAgg} data={chartData} isAnimationActive fill="hsl(var(--accent))">
